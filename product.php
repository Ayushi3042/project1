	...
	?>
		<div class="col-md-4">
			<form method="post" action="product.php?action=add&id=<?php echo $row["ID"];?>">
				<div style="border:1px solid#333; backgroundcolor:#f1f1f1;border-radius:5px;padding:16px;width:400px;"align="center" >
				<h4 class="text-info"><?php echo $row["name"];?></h4>
				<img src="<?php echo $row["image"];?>" class="img-responsive/><br/>
				<h4 class="text-danger">$<?php echo $row["price"];?></h4>
				
				<input type="text" name="quantity" class="form-control" value="1" />
				<input type="hiden" name="hidden_name" value="<?php echo $row["price"];?>"/>
